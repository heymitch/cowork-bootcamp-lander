...
function Hero() {
  return (
    <section className="relative w-full min-h-[900px] bg-page overflow-hidden">
      {/* Background image - full hero composite */}
      <img
      ...
      />
      {/* Badge */}
      <div className="absolute top-6 left-1/2 -translate-x-1/2 flex items-center gap-2 bg-black/80 backdrop-blur px-4 py-2 rounded-full z-10">
      ...
      {/* Content overlay */}
      <div className="relative z-10 flex flex-col justify-end h-full min-h-[900px] px-8 md:px-24 pb-16">
        <div className="max-w-[540px]">
          <img src="/images/logo.png" alt="Claude Cowork Bootcamp" className="h-8 mb-6" />
          <h1 className="font-anton text-[80px] md:text-[96px] leading-[0.9] text-red uppercase mb-6">
            Cowork<br />Bootcamp
          </h1>
          <h2 className="font-manrope text-[32px] font-bold text-cream mb-4">
            Build .Skills
          </h2>
          <p className="font-barlow text-[20px] text-cream/70 mb-2">
