(function() {
  ...
  style.textContent = [
    ...
    '.bc-widget__input { flex:1; border:1px solid rgba(0,0,0,.12); border-radius:8px; padding:9px 12px; font-size:14px; outline:none; font-family:inherit; resize:none; transition:border-color .15s; background:#fff; color:#1a1a1a; }',
